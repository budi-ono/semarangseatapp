...
const ResourceLeadProjectsPage = () => {
  ...
  return (
    <div className="animate-fade-in space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-accenture-gray-900">Projects Overview</h1>
        <p className="text-accenture-gray-600 mt-1">
          Monitor all ongoing and planned projects
        </p>
      </div>
...
export default ResourceLeadProjectsPage;